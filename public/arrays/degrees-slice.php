...
$degrees = [32.3, 31.3, 28.2, 29.3, 29.7, 29.9, 28.7, 28.4, 30.5, 30.5, 31.7, 30.6, 29.4, 32.0,
...
sort($degrees); // ordena un array

$lowestTemperatures = array_slice($degrees, 0, 5);

$lowestTemperatures = implode(", ", $lowestTemperatures);

$highestTemperatures = array_slice($degrees, -5, 5);
