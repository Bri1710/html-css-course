...
$products = doQuery($dbConnection, "SELECT * FROM products");
...
function getClasses(array $product): string
{
    $classes = "";

    if ($product["release"] >= "2022-03-25"){
        $classes = $classes . " new";
    }

    if (str_contains($product["name"], "jeans")){
        $classes .= " best";
    }
...
<div class="featured container no-gutter">
    <div class="row posts">
        <?php foreach ($products as $product): ?>
            <div id="<?php echo $product["idproducts"] ?>" class="item col-md-4 <?php echo getClasses($product) ?>">
