...
$aboutText1 = new Info("Our philosophy", '"Team work makes the dream work"', "Get your 10% discount code");
$aboutText2 = new Info("Subscribe to PIXIE now!", "", "");
  ...
  <body>
    ...
    <div id="pre-header">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <span><?php echo $aboutText1->getSecondText(); ?></span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <h1><?php echo $aboutText1->getTitle(); ?></h1>
            </div>
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="right-content">
              <h4><?php echo $aboutText1->getFirstText(); ?></h4>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <div class="line-dec"></div>
              <h1><?php echo $aboutText2->getTitle(); ?></h1>
            </div>
          </div>
          <div class="col-md-8 offset-md-2">
            <div class="main-content">
              <p><?php echo $aboutText1->getSecondText(); ?></p>
              <div class="container">
